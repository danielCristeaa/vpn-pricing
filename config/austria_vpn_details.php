...
return [
    ...
    'section_three_image_path' => '/assets/austria/section3_image.png',
    'section_three_title' => 'Stay safe on public Wi-Fis networks',
    'section_three_text' => 'Wireless connections are so common nowadays that we don’t even stop to think the dangers they might pose. Here’s the catch. The networks you use in cafés, airports, or hotels usually lack a secure setup or even a password.<br><br> This means that every time you go online using an unsecured Wi-Fi network, you risk exposing your data.<br><br> You should know that cybercrime has become a very lucrative business, so hackers have every reason to keep perfecting their methods. This is worrying when you consider that there is already a multitude of malicious associations and attacks that target open Wi-Fi networks.<br><br> Therefore it’s important to secure your online presence no matter where you are. Our military-grade encryption offers the best protection available and even today’s supercomputers can’t get past it.',

    'section_four_image_path' => '/assets/austria/section4_image.png',
    'section_four_title' => 'Smash all geo-restrictions',
    'section_four_text' => 'By now, we’re mostly familiar with geo-restrictions and how frustrating they can be. Due to licensing issues many foreign TV shows and movies are restricted in Austria.<br><br> Most streaming services detect your location based on your IP address. Then they decide what content is available for you to watch.<br><br> One popular example of this is Netflix. Even if you have a subscription, you still can’t get the entire library of content in Austria.<br><br> The same holds true for Amazon Prime or YouTube Premium. Other services, like Hulu or BBC aren’t available to view within Austrian borders at all.<br><br> However, with our VPN service by your side, that’s no longer the case. CyberGhost VPN allows you to hide your IP address and replace it with another one from our network. This way, their localization software will no longer be able to detect your real location.<br><br> And if you’re travelling abroad and feel homesick, CyberGhost VPN makes it easy to catch up with all from favorite shows on ORF.',
